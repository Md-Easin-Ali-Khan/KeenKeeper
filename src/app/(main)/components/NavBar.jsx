      ...
      <div className="shadow-sm flex justify-between items-center px-4 md:px-20">
        ...
        <div>
          <ul className="hidden md:flex menu menu-horizontal p-0">
            <li>
              <Link
                className={`${pathname === "/" ? "text-white bg-[#244D3F]" : ""} btn py-3 px-4 font-semibold text-[16px] text-gray-500`}
                href={"/"}
              >
                <House className="w-5 h-5"></House>Home
              </Link>
            </li>
            <li>
              <Link
                className={`${pathname === "/timeline" ? "text-white bg-[#244D3F]" : ""} btn py-3 px-4 font-semibold text-[16px] text-gray-500`}
                href={"/timeline"}
              >
                <Clock3 className="w-5 h-5"></Clock3>Timeline
              </Link>
            </li>
            <li>
              <Link
                className={`${pathname === "/stats" ? "text-white bg-[#244D3F]" : ""} btn py-3 px-4 font-semibold text-[16px] text-gray-500`}
                href={"/stats"}
              >
                <ChartLine className="w-5 h-5"></ChartLine>Stats
              </Link>
            </li>
          </ul>
